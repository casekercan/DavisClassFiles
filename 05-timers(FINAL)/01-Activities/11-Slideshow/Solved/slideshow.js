...
function nextImage() {
  ...
  if (count === images.length) {
    document.write('<img src="http://getwallpapers.com/wallpaper/full/6/9/3/34637.jpg" height="100%" width="100%">')
    var audio = new Audio('images/tasmanian-devil-daniel_simon.mp3');
    audio.play();
  }
}
